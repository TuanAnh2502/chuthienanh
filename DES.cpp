...
int main()
{
	unsigned int K1 = 0x19A10010 ; //4byte 
	unsigned int K2 = 0x252ABCDE ;
	printf("\nKhoa K = "); ShowByte(K1); ShowByte(K2);
	unsigned int M1 = 0x19A10010;//85E813540F0AB405
	unsigned int M2 = 0x252BCEFA;
